...
PWA Studio enables you to audit with PWABuilder during development, not just after your PWA has gone live.
...
We are now ready to audit our app's loading performance, or how fast your PWA loads on different devices with varying network connections.
