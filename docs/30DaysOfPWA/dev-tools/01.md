...
PWA Studio uses Git to fork the latest version of the PWA Starter and then installs the needed dependencies using `npm`. If you're missing either of these tools, PWA Studio will show a warning and direct you towards getting them installed.
