...
[The PWA Starter](https://aka.ms/learn-PWA/30Days-3.1/github.com/pwa-builder/pwa-starter) is a code template (similar to what tools like create-react-app or the Angular CLI can generate) that gives you everything, yes everything, you need to build a high quality PWA. Tired of having to:
...
PWA Studio is an extension that makes [VSCode](https://aka.ms/learn-PWA/30Days-3.1/code.visualstudio.com) the **best** platform for building PWAs. When you [install PWA Studio](https://aka.ms/learn-PWA/30Days-3.1/pwa-studio), you can:
