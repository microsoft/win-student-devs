...
There's a ton of options, but for the sake of simplicity, we'll just be looking at one technology we can leverage in maintainable projects: **web components!**
