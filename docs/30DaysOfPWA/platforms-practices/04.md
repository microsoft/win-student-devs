...
The API for IndexedDB can be a bit low-level for normal usage, so we'll be taking a look at simple wrapper called [LocalForage](https://localforage.github.io/localForage/).
