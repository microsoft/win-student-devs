...
* [Use Service Workers to manage network requests and push notifications](https://docs.microsoft.com/en-us/microsoft-edge/progressive-web-apps-chromium/how-to/service-workers) (Edge Developer Documentation)
