...
### 2.1 | &nbsp; [Introducing the advanced capabilities of Progressive Web Apps](09.md) 
...
### 2.4 | &nbsp; [Displaying content more like an app](12.md) 
* Display modes
...
### 2.5 | &nbsp; [Caching your app’s data](13.md) 
* Multiple caches
* Pruning stale data
...
### 2.6 | &nbsp; [Synchronizing app data in the background](14.md) 
* Background Sync API
...
### 2.7 | &nbsp; [Notifying your users of updates](15.md) 
* Badging API
* Push API
* Notifications API
