...
The next step was to take my local app and deploy it to an HTTPS-enabled server so I can satisfy one core requirement of PWA: _make it secure!_.
...
**Want to see the code?** Check out [this repository](https://github.com/fearlessly-dev/recipe-me) to see the changes made in each step of this process. _Caveat:_ I plan to continue working with this to make more improvements. 
...
The [SETUP](https://github.com/fearlessly-dev/recipe-me/blob/main/SETUP.md) page should document these changes as I go, in case you want to follow along!
