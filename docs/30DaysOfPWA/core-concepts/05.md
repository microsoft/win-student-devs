...
But first, take a minute to inspect your chosen [Sample PWA](https://aka.ms/learn-PWA/30Days-1.5/docs.microsoft.com/en-us/microsoft-edge/progressive-web-apps-chromium/demo-pwas) and look for its service worker implementation. Keep that open in a tab so you can explore it in the context of this discussion. I'm using [DevTools Tips](https://aka.ms/learn-PWA/30Days-1.5/devtoolstips.org) and I've made a copy of its `sw.js` file in [this gist](https://aka.ms/learn-PWA/30Days-1.5/gist.github.com/nitya/3aa3b72dc6abb177b577574f32382c7d) for my reference.
